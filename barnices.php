...
<!--                     <div class="pull-right col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="grid_shop row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="entry">
                            <img src="images/barnices/1.jpg" alt="" class="img-responsive">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/2.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/3.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/4.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/5.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/6.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="gallery_item">
                        <div class="entry">
                            <img src="images/barnices/7.jpg" alt="" class="img-responsive">
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <!-- <a class="sg" rel="bookmark" href="contacto.html"><i class="fa fa-link"></i></a> -->
                                    <a class="st" rel="bookmark" href="contacto.php"><i class="fa fa-shopping-cart"></i></a>
