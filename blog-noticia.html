...
<div class="loader">Isotech...</div>
    ...
    <div class="topbar">
      <div class="container">
          <div class="row">
            ...
            <span class="facebook"><a data-toggle="tooltip" data-placement="bottom" title="Facebook" href="https://es-la.facebook.com/"><i class="fa fa-facebook"></i></a></span>
            
            <span class="twitter"><a data-toggle="tooltip" data-placement="bottom" title="Twitter" href="https://twitter.com/login?lang=es"><i class="fa fa-twitter"></i></a></span>
            <span class="linkedin"><a data-toggle="tooltip" data-placement="bottom" title="youtube" href="https://www.youtube.com/"><i class="fa fa-youtube"></i></a></span>
  ...
  <div class="post-wrapper-top clearfix">
    <div class="container">
      <div class="col-lg-12">
        <h2>LA NOTICIA DESPLEGADA</h2>
                <ul class="breadcrumb pull-right">
                    <li><a href="index.html">Inicio</a></li>
                    <li>La Noticia Desplegada</li>
                </ul>
      </div>
    </div>
      ...
      <div class="container">
        <div id="content" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="media-elements">
                    <img src="demos/single_blog.jpg" alt="" class="img-responsive">
                </div>
                
                <div class="single-title">
                  <h2>Drci id condimentum eleifend</h2>
                </div><!-- end title -->
       ...
       <!-- Go to www.addthis.com/dashboard to customize your tools --> <div class="addthis_inline_share_toolbox"></div>
                ...
                <!-- <blockquote>Alesuada sit amet. Aliquam vel vestibulum metus. Aenean ut mi auctor, bibendum urna vitae, semper leo. In dolor sem, adipiscing id rhoncus ut, tempus id purus. Vivamus blandit, ipsum in varius auctor, urna dui accumsan nisl, nec tincidunt mauris risus non erat. Nulla eget enim euismod, molestie sem eu, posuere purus. </blockquote> -->
                <p>Integer egestas, orci id condimentum eleifend, nibh nisi pulvinar eros, vitae ornare massa neque ut orci. Nam aliquet lectus sed odio eleifend, at iaculis dolor egestas. Nunc elementum pellentesque augue sodales porta. Etiam aliquet rutrum turpis, feugiat sodales ipsum consectetur nec. </p>
